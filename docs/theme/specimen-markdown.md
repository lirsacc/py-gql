...
Sphinx can be configured to use markdown using the [recommonmark](https://github.com/readthedocs/recommonmark) extension. recommonmark is strict and does not natively support tables or common extensions to markdown.
...
eros. [Nulla aliquam](#markdown-specimen) orci sit amet nisl posuere malesuada. Proin aliquet
...
> **Sed aliquet**, neque at rutrum mollis, neque nisi tincidunt nibh, vitae
  ...
  [libero fermentum](#markdown-specimen) urna, ut efficitur elit ligula et nunc.
>
...
2. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur
  ...
  pellentesque lacinia eu vel odio.
    ...
    3. Pellentesque eget ornare tellus, ut gravida mi.
...
**Note**: Markdown table syntax requires [`sphinx_markdown_tables`](https://pypi.org/project/sphinx-markdown-tables/).
