...
default_validator = partial(
    validate_with_rules, rules=SPECIFIED_RULES
)  # type: Validator
...
def validate_ast(
    ...
    *,
    ...
    """
    Check that a document is a valid GraphQL query document.

    This runs the parse tree through a list of validation callables given a
    :class:`~py_gql.schema.Schema` instance.

    Warning:
        THe validation process assumes the ast is a document generated by
