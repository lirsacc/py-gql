...
# performance (to be proven). This would also require as good error messages
# which eliminates some parser generators with bad disambiguation. Anyway,
# this is unlikely to be the main bottleneck so this is definitely low prio.
