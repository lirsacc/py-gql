# -*- coding: utf-8 -*-
""" Converting AST and values into nicely formatted strings.
"""
...
def print_ast(node):  # noqa: C901
    ...
    if kind is _ast.OperationDefinition:
        ...
        return (
            ...
            selection_set
            if ((not name) and (not directives) and (not var_defs) and
                (op == 'query' or not op))
            else _join([
                op,
                _join([name, var_defs]),
