# -*- coding: utf-8 -*-
""" Parser tests.
Ported from: https://github.com/graphql/graphql-js/blob/master/src/language/__tests__/schema-parser-test.js  # noqa: E501
...
def _field(loc, name, type_, args=[]):
    return _ast.FieldDefinition(
        loc=loc, name=name, type=type_, arguments=args, directives=[])


def _input(loc, name, type_, default_value=None):
    return _ast.InputValueDefinition(
        loc=loc, name=name, type=type_, default_value=default_value,
        directives=[])
...
'''
    assert_node_equal(parse(body), _doc((0, 39), [
...
interface Hello {
  world: String
    ...
    assert_node_equal(parse(body), _doc((0, 36), [
...
type Hello {
  world(flag: Boolean): String
    ...
    assert_node_equal(parse(body), _doc((0, 46), [
        _ast.ObjectTypeDefinition(
            loc=(1, 46),
            name=_name((6, 11), 'Hello'),
            interfaces=[],
...
type Hello {
  world(flag: Boolean = true): String
    ...
    assert_node_equal(parse(body), _doc((0, 53), [
        _ast.ObjectTypeDefinition(
            loc=(1, 53),
            name=_name((6, 11), 'Hello'),
            interfaces=[],
...
type Hello {
  world(things: [String]): String
    ...
    assert_node_equal(parse(body), _doc((0, 49), [
        _ast.ObjectTypeDefinition(
            loc=(1, 49),
            name=_name((6, 11), 'Hello'),
            interfaces=[],
...
type Hello {
  world(argOne: Boolean, argTwo: Int): String
    ...
    assert_node_equal(parse(body), _doc((0, 61), [
        _ast.ObjectTypeDefinition(
            loc=(1, 61),
            name=_name((6, 11), 'Hello'),
            interfaces=[],
...
def test_it_parses_simple_union():
    assert_node_equal(parse('union Hello = World'), _doc((0, 19), [
...
def test_it_parses_union_with_two_types():
    assert_node_equal(parse('union Hello = Wo | Rld'), _doc((0, 22), [
        _ast.UnionTypeDefinition(
            loc=(0, 22),
            name=_name((6, 11), 'Hello'),
            directives=[],
...
def test_it_parses_union_with_two_types_and_leading_pipe():
    assert_node_equal(parse('union Hello = | Wo | Rld'), _doc((0, 24), [
        _ast.UnionTypeDefinition(
            loc=(0, 24),
            name=_name((6, 11), 'Hello'),
            directives=[],
...
def test_it_parses_scalar():
    assert_node_equal(parse('scalar Hello'), _doc((0, 12), [
...
input Hello {
  world: String
    ...
    assert_node_equal(parse(body), _doc((0, 32), [
