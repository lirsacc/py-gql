...
from py_gql.validation import ValuesOfCorrectTypeChecker
from .._test_utils import assert_checker_validation_result as run_test


def test_good_int_value(schema):
    run_test(ValuesOfCorrectTypeChecker, schema, '''
    {
        complicatedArgs {
...
@pytest.mark.parametrize('value,expected_err,loc', [
    pytest.param(
        '1', 'Expected type String, found 1', (70, 71),
        id='int -> string'
    ),
    pytest.param(
        '1.0', 'Expected type String, found 1.0', (70, 73),
        id='float -> string'
    ),
    pytest.param(
        'true', 'Expected type String, found true', (70, 74),
        id='bool -> string'
    ),
    pytest.param(
        'BAR', 'Expected type String, found BAR', (70, 73),
        id='enum -> string'
    ),
])
...
@pytest.mark.parametrize('value,expected_err,loc', [
    pytest.param(
        '"3"', 'Expected type Int, found "3"', (64, 67),
        id='string -> int'
    ),
    pytest.param(
    ...
    pytest.param(
        'FOO', 'Expected type Int, found FOO', (64, 67),
        id='enum -> int'
    ),
    pytest.param(
        '3.0', 'Expected type Int, found 3.0', (64, 67),
        id='float -> int'
    ),
    pytest.param(
        'true', 'Expected type Int, found true', (64, 68),
        id='bool -> int'
    ),
    pytest.param(
        '3.333', 'Expected type Int, found 3.333', (64, 69),
        id='float -> int'
    ),
])
...
@pytest.mark.parametrize('value,expected_err,loc', [
    pytest.param('"3"', 'Expected type Float, found "3"', (68, 71),
                 id='string -> float'),
    pytest.param('"3.333"', 'Expected type Float, found "3.333"', (68, 75),
                 id='string -> float'),
    pytest.param('true', 'Expected type Float, found true', (68, 72),
                 id='bool -> float'),
    pytest.param('FOO', 'Expected type Float, found FOO', (68, 71),
                 id='enum -> float'),
])
...
@pytest.mark.parametrize('value,expected_err,loc', [
    pytest.param('2', 'Expected type Boolean, found 2', (72, 73),
                 id='int -> boolean'),
    pytest.param('1.0', 'Expected type Boolean, found 1.0', (72, 75),
                 id='float -> boolean'),
    pytest.param('"true"', 'Expected type Boolean, found "true"', (72, 78),
                 id='string -> boolean'),
    pytest.param('TRUE', 'Expected type Boolean, found TRUE', (72, 76),
                 id='enum -> boolean'),
])
...
@pytest.mark.parametrize('value,expected_err,loc', [
    pytest.param('1.0', 'Expected type ID, found 1.0', (62, 65),
                 id='float -> ID'),
    pytest.param('true', 'Expected type ID, found true', (62, 66),
                 id='boolean -> ID'),
    pytest.param('SOMETHING', 'Expected type ID, found SOMETHING', (62, 71),
                 id='enum -> ID'),
])
...
@pytest.mark.parametrize('value,expected_err,loc', [
    pytest.param('1', 'Expected type DogCommand, found 1', (61, 62),
                 id='int -> enum'),
    pytest.param('1.0', 'Expected type DogCommand, found 1.0', (61, 64),
                 id='float -> enum'),
    pytest.param('"SIT"', 'Expected type DogCommand, found "SIT"', (61, 66),
                 id='string -> enum'),
    pytest.param('true', 'Expected type DogCommand, found true', (61, 65),
                 id='boolean -> enum'),
    pytest.param('JUGGLE', 'Expected type DogCommand, found JUGGLE', (61, 67),
                 id='unknown enum -> enum'),
    pytest.param('sit', 'Expected type DogCommand, found sit', (61, 64),
...
@pytest.mark.parametrize('value,expected_err,loc', [
    pytest.param('["one", 2]', 'Expected type String, found 2', (86, 87),
                 id='incorrect item type'),
    pytest.param('1', 'Expected type [String], found 1', (78, 79),
...
@pytest.mark.parametrize('value,expected_errors,locs', [
    pytest.param(
        '''
        {
          complicatedArgs {
...
def test_variables_with_complex_invalid_default_values(schema):
    ...
    ''', [
        'Expected type Boolean!, found 123',
