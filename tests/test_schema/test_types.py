...
from py_gql.schema import (
    EnumType, UUID, RegexType, String, Int, Float, Boolean)
from py_gql.exc import (
    UnknownEnumValue, ScalarSerializationError, ScalarParsingError)
...
@pytest.mark.parametrize('type, input, err', [
...
class TestUUID(object):
    ...
    def test_parse_string(self):
        assert (UUID.parse("c4da8450-ec7a-4d3b-9ade-18194daeb2d6") ==
                uuid.UUID("c4da8450-ec7a-4d3b-9ade-18194daeb2d6"))
