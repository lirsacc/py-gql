...
from py_gql.schema import (
    Schema, String, ObjectType, Field, Int, ListType, NonNullType)
from ._test_utils import check_execution


def run_test(test_type, test_data, expected_data=None, expected_errors=None,
             expected_exc=None, expected_msg=None):

    data = {'test': test_data}
    data_type = ObjectType('DataType', [
...
@pytest.mark.parametrize('data, expected', [
    ...
    pytest.param(_lazy([1, None, 2]), [1, None, 2],
...
@pytest.mark.parametrize('data, expected_err', [
